...
OUTPUT_DIR=${OUTPUT_DIR:-'${root_experiments_dir}/mapanything/benchmarking/rs_guided_dense_mv/newyork/da3_unified'}
...
PYTHONPATH=/root/autodl-tmp/Models/Depth-Anything-3/src:. CUDA_VISIBLE_DEVICES=1 python3 \
