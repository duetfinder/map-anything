...
TRAIN_SETS=${TRAIN_SETS:-8}
VAL_SETS=${VAL_SETS:-2}
TEST_SETS=${TEST_SETS:-2}
LOSS_CONFIG=${LOSS_CONFIG:-pi3_rs_only_pointmap_only_l1_loss}
...
OUTPUT_DIR=${OUTPUT_DIR:-'${root_experiments_dir}/mapanything/training/vigor_chicago/p2a/'${LOSS_CONFIG}}
