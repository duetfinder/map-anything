...
OUTPUT_DIR=${OUTPUT_DIR:-'${root_experiments_dir}/mapanything/training/vigor_chicago/p3_pi3_joint_input_500_2gpu_all_low_covis'}
...
PYTHONPATH=. CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node "${NUM_GPUS}" \
    ...
    dataset.vigor_chicago_joint_rs_aerial.train.view_sampling_mode=low_covis \
    dataset.vigor_chicago_joint_rs_aerial.val.view_sampling_mode=low_covis \
    dataset.vigor_chicago_joint_rs_aerial.test.view_sampling_mode=low_covis \
