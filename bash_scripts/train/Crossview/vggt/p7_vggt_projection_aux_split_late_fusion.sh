...
NUM_GPUS=${NUM_GPUS:-${1:-5}}
CUDA_DEVICES=${CUDA_DEVICES:-0,1,2,3,4}
...
echo "P7 projection auxiliary split remote aggregator"
...
PYTHONPATH=. CUDA_VISIBLE_DEVICES="${CUDA_DEVICES}" torchrun --nproc_per_node "${NUM_GPUS}" \
    ...
    loss=vggt_loss_rs_joint_p7_projection_aux \
    ...
    train_params=vggt_p7_projection_aux \
