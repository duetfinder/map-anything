...
REMOTE_CONTROL_RANKING_LOSS_WEIGHT=${REMOTE_CONTROL_RANKING_LOSS_WEIGHT:-0.2}
REMOTE_CONTROL_RANKING_MARGIN=${REMOTE_CONTROL_RANKING_MARGIN:-0.01}
REMOTE_CONTROL_RANKING_MODES=${REMOTE_CONTROL_RANKING_MODES:-[blank,shuffled]}
...
RESUME=${RESUME:-false}
TRAIN_PARAMS=${TRAIN_PARAMS:-vggt_p7k_projection_aux_control_ranking}
LOSS_CONFIG=${LOSS_CONFIG:-vggt_loss_rs_joint_p7h_projection_aux_robust_branch}
EXPERIMENT_NAME=${EXPERIMENT_NAME:-p7l_vggt_crossattn_projection_aux_aerial_ranking}
...
echo "P7L cross-attention projection_aux aerial-control-ranking"
