...
REMOTE_TOP_N_PERCENT=${REMOTE_TOP_N_PERCENT:-0.0}
...
OUTPUT_DIR=${OUTPUT_DIR:-'${root_experiments_dir}/mapanything/training/Crossview/vggt/p5b_vggt_joint_shared_all_shared_norm'}
...
echo "REMOTE_TOP_N_PERCENT=${REMOTE_TOP_N_PERCENT}"
