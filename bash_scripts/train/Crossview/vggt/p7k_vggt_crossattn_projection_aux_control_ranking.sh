...
REMOTE_CONTROL_RANKING_LOSS_WEIGHT=${REMOTE_CONTROL_RANKING_LOSS_WEIGHT:-0.1}
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-p7k_vggt_crossattn_projection_aux_control_ranking}
...
echo "P7K cross-attention projection_aux control-ranking"
...
echo "REMOTE_CONTROL_RANKING=${REMOTE_CONTROL_RANKING_LOSS_WEIGHT} MODES=${REMOTE_CONTROL_RANKING_MODES} MARGIN=${REMOTE_CONTROL_RANKING_MARGIN}"
