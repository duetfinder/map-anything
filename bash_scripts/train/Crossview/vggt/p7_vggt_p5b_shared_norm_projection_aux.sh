...
PROJ_OFFSET_TO_POINT_DETACH=${PROJ_OFFSET_TO_POINT_DETACH:-0.0}
PROJ_OFFSET_TO_POINT_CENTERED_DETACH=${PROJ_OFFSET_TO_POINT_CENTERED_DETACH:-0.0}
...
PROJ_OFFSET_RESIDUAL_FROM_POINT_DETACH=${PROJ_OFFSET_RESIDUAL_FROM_POINT_DETACH:-false}
PROJ_POINT_OFFSET_TO_GT=${PROJ_POINT_OFFSET_TO_GT:-0.0}
PROJ_POINT_OFFSET_TO_GT_START_EPOCH=${PROJ_POINT_OFFSET_TO_GT_START_EPOCH:-0.0}
PROJ_POINT_OFFSET_TO_GT_RAMP_EPOCHS=${PROJ_POINT_OFFSET_TO_GT_RAMP_EPOCHS:-0.0}
PROJ_POINT_RESIDUAL_OFFSET_TO_GT=${PROJ_POINT_RESIDUAL_OFFSET_TO_GT:-0.0}
PROJ_POINT_RESIDUAL_XYZ_TO_GT=${PROJ_POINT_RESIDUAL_XYZ_TO_GT:-0.0}
...
PROJ_RECON_GLOBAL_TO_GT_USE_GT_DIR=${PROJ_RECON_GLOBAL_TO_GT_USE_GT_DIR:-false}
PROJ_RECON_GLOBAL_TO_GT_USE_GT_SLOPE=${PROJ_RECON_GLOBAL_TO_GT_USE_GT_SLOPE:-false}
PROJ_RECON_GLOBAL_TO_GT_DETACH_DIR_SLOPE=${PROJ_RECON_GLOBAL_TO_GT_DETACH_DIR_SLOPE:-true}
...
PROJ_GRID_GLOBAL_TO_GT_USE_GT_DIR=${PROJ_GRID_GLOBAL_TO_GT_USE_GT_DIR:-false}
PROJ_GRID_GLOBAL_TO_GT_USE_GT_SLOPE=${PROJ_GRID_GLOBAL_TO_GT_USE_GT_SLOPE:-false}
PROJ_GRID_GLOBAL_TO_GT_DETACH_DIR_SLOPE=${PROJ_GRID_GLOBAL_TO_GT_DETACH_DIR_SLOPE:-true}
...
echo "PROJ offset_to_point_detach=${PROJ_OFFSET_TO_POINT_DETACH} centered=${PROJ_OFFSET_TO_POINT_CENTERED_DETACH} residual_from_point_detach=${PROJ_OFFSET_RESIDUAL_FROM_POINT_DETACH} point_offset_to_gt=${PROJ_POINT_OFFSET_TO_GT} point_offset_to_gt_start=${PROJ_POINT_OFFSET_TO_GT_START_EPOCH} point_offset_to_gt_ramp=${PROJ_POINT_OFFSET_TO_GT_RAMP_EPOCHS} point_residual_offset_to_gt=${PROJ_POINT_RESIDUAL_OFFSET_TO_GT} point_residual_xyz_to_gt=${PROJ_POINT_RESIDUAL_XYZ_TO_GT}"
...
echo "PROJ_RECON_TO_GT_HIGH_Z quantile=${PROJ_RECON_TO_GT_HIGH_Z_QUANTILE} min_pixels=${PROJ_RECON_TO_GT_HIGH_Z_MIN_PIXELS} global_use_gt_dir=${PROJ_RECON_GLOBAL_TO_GT_USE_GT_DIR} global_use_gt_slope=${PROJ_RECON_GLOBAL_TO_GT_USE_GT_SLOPE} detach=${PROJ_RECON_GLOBAL_TO_GT_DETACH_DIR_SLOPE}"
echo "PROJ_GRID_GLOBAL_TO_GT weight=${PROJ_GRID_GLOBAL_TO_GT} high_z_q=${PROJ_GRID_GLOBAL_TO_GT_HIGH_Z_QUANTILE} min_pixels=${PROJ_GRID_GLOBAL_TO_GT_HIGH_Z_MIN_PIXELS} use_gt_dir=${PROJ_GRID_GLOBAL_TO_GT_USE_GT_DIR} use_gt_slope=${PROJ_GRID_GLOBAL_TO_GT_USE_GT_SLOPE} detach_dir_slope=${PROJ_GRID_GLOBAL_TO_GT_DETACH_DIR_SLOPE}"
...
PYTHONPATH=. CUDA_VISIBLE_DEVICES="${CUDA_DEVICES}" torchrun --master_port "${MASTER_PORT}" --nproc_per_node "${NUM_GPUS}" \
    ...
    loss.remote_projection_offset_to_point_detach_loss_weight=${PROJ_OFFSET_TO_POINT_DETACH} \
    loss.remote_projection_offset_to_point_centered_detach_loss_weight=${PROJ_OFFSET_TO_POINT_CENTERED_DETACH} \
    loss.remote_projection_offset_residual_from_point_detach=${PROJ_OFFSET_RESIDUAL_FROM_POINT_DETACH} \
    loss.remote_projection_point_offset_to_gt_loss_weight=${PROJ_POINT_OFFSET_TO_GT} \
    loss.remote_projection_point_offset_to_gt_start_epoch=${PROJ_POINT_OFFSET_TO_GT_START_EPOCH} \
    loss.remote_projection_point_offset_to_gt_ramp_epochs=${PROJ_POINT_OFFSET_TO_GT_RAMP_EPOCHS} \
    loss.remote_projection_point_residual_offset_to_gt_loss_weight=${PROJ_POINT_RESIDUAL_OFFSET_TO_GT} \
    loss.remote_projection_point_residual_xyz_to_gt_loss_weight=${PROJ_POINT_RESIDUAL_XYZ_TO_GT} \
    ...
    loss.remote_projection_reconstruct_global_to_gt_use_gt_dir=${PROJ_RECON_GLOBAL_TO_GT_USE_GT_DIR} \
    loss.remote_projection_reconstruct_global_to_gt_use_gt_slope=${PROJ_RECON_GLOBAL_TO_GT_USE_GT_SLOPE} \
    loss.remote_projection_reconstruct_global_to_gt_detach_dir_slope=${PROJ_RECON_GLOBAL_TO_GT_DETACH_DIR_SLOPE} \
    ...
    loss.remote_projection_grid_global_to_gt_use_gt_dir=${PROJ_GRID_GLOBAL_TO_GT_USE_GT_DIR} \
    loss.remote_projection_grid_global_to_gt_use_gt_slope=${PROJ_GRID_GLOBAL_TO_GT_USE_GT_SLOPE} \
    loss.remote_projection_grid_global_to_gt_detach_dir_slope=${PROJ_GRID_GLOBAL_TO_GT_DETACH_DIR_SLOPE} \
    model=vggt \
