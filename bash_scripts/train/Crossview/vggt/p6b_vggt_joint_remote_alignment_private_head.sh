#!/bin/bash
set -euo pipefail
export TRAIN_PARAMS=${TRAIN_PARAMS:-vggt_p6b_joint_remote_alignment_private_head}
export P6B_VARIANT=${P6B_VARIANT:-private_head}
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-p6b_vggt_joint_remote_alignment_private_head_w03}
