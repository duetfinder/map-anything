...
REMOTE_SCENE_MATCHING_LOSS_WEIGHT=${REMOTE_SCENE_MATCHING_LOSS_WEIGHT:-0.2}
REMOTE_SCENE_MATCHING_TEMPERATURE=${REMOTE_SCENE_MATCHING_TEMPERATURE:-0.1}
...
RESUME=${RESUME:-false}
TRAIN_PARAMS=${TRAIN_PARAMS:-vggt_p7n_projection_aux_scene_matching}
LOSS_CONFIG=${LOSS_CONFIG:-vggt_loss_rs_joint_p7h_projection_aux_robust_branch}
EXPERIMENT_NAME=${EXPERIMENT_NAME:-p7n_vggt_crossattn_projection_aux_scene_matching}
...
echo "P7N cross-attention projection_aux scene-matching"
...
echo "REMOTE_SCENE_MATCHING=${REMOTE_SCENE_MATCHING_LOSS_WEIGHT} TEMP=${REMOTE_SCENE_MATCHING_TEMPERATURE}"
