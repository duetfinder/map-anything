...
OUTPUT_DIR=${OUTPUT_DIR:-'${root_experiments_dir}/mapanything/training/Crossview/vggt/p5e_vggt_remote_head_attention_viewtype'}
...
PYTHONPATH=. CUDA_VISIBLE_DEVICES="${CUDA_DEVICES}" torchrun --nproc_per_node "${NUM_GPUS}" \
    ...
    train_params=vggt_p5e_remote_head_attention \
