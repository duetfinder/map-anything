...
OUTPUT_DIR=${OUTPUT_DIR:-'${root_experiments_dir}/mapanything/training/Crossview/vggt/p5f_vggt_lite_early_bias_gated_residual'}
...
echo "P5f-lite: early view-type embedding + remote-to-aerial gated residual"
echo "Freezing ordinary decoders: model.camera_head, model.depth_head, model.point_head"
