...
RESUME=${RESUME:-false}
TRAIN_PARAMS=${TRAIN_PARAMS:-vggt_p7n2_projection_aux_scene_matching_gather}
LOSS_CONFIG=${LOSS_CONFIG:-vggt_loss_rs_joint_p7h_projection_aux_robust_branch}
EXPERIMENT_NAME=${EXPERIMENT_NAME:-p7n2_vggt_crossattn_projection_aux_scene_matching_gather}
...
echo "P7N2 cross-attention projection_aux scene-matching gather"
...
echo "REMOTE_SCENE_MATCHING=${REMOTE_SCENE_MATCHING_LOSS_WEIGHT} TEMP=${REMOTE_SCENE_MATCHING_TEMPERATURE} GATHER=${REMOTE_SCENE_MATCHING_GATHER_DISTRIBUTED}"
